...
function MainNav() {
  ...
  const options: NavOptions[] = [
    {
      name: 'hand',
      icon: <Hand strokeWidth={1.69} className={`${iconStyle}`} />,
    },
    {
      name: 'rectangle',
      icon: (
        <RectangleHorizontal className={`${iconStyle}`} strokeWidth={1.69} />
      ),
    },
    {
      name: 'square',
      icon: <Square className={`${iconStyle}`} strokeWidth={1.69} />,
    },
    {
      name: 'diamond',
      icon: <Diamond className={`${iconStyle}`} strokeWidth={1.69} />,
    },
    {
      name: 'circle',
      icon: <Circle className={`${iconStyle}`} strokeWidth={1.69} />,
    },
    {
      name: 'line',
      icon: <Slash className={`${iconStyle}`} strokeWidth={1.7} />,
    },
    {
      name: 'arrow',
      icon: <ArrowRight className={`${iconStyle}`} strokeWidth={1.69} />,
    },
    {
      name: 'draw',
      icon: <Pencil className={`${iconStyle}`} strokeWidth={1.69} />,
    },
    {
      name: 'text',
